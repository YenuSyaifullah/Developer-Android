package id.ac.poliban.mi.vd.yenu.notifyme;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_UPDATE_NOTIFICATION =
            "id.ac.poliban.mi.vd.yenu.notifyme.ACTION_UPDATE_NOTIFICATION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("NotifyMe! Yenu");
    ...
    public void sendNotification() {
        ...
        @SuppressLint("UnspecifiedImmutableFlag") PendingIntent updatePendingIntent = PendingIntent.getBroadcast(this,
